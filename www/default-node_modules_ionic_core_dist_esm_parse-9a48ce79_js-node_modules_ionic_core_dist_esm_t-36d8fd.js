...
var warnIfValueOutOfBounds = function warnIfValueOutOfBounds(value, min, max) {
  ...
  var _iterator = (0,_home_user_vestapp_arnaldo_Projetos_vestapp_aplicativo_node_modules_babel_runtime_helpers_esm_createForOfIteratorHelper_js__WEBPACK_IMPORTED_MODULE_1__["default"])(valueArray),
      _step;
...
var getDaysOfMonth = function getDaysOfMonth(month, year, firstDayOfWeek) {
  ...
  for (var _i = 0; _i <= offset; _i++) {
    days = [{
      day: null,
      dayOfWeek: null
    }].concat((0,_home_user_vestapp_arnaldo_Projetos_vestapp_aplicativo_node_modules_babel_runtime_helpers_esm_toConsumableArray_js__WEBPACK_IMPORTED_MODULE_0__["default"])(days));
  }
...
var getAllMonthsInRange = function getAllMonthsInRange(currentParts, maxParts) {
  ...
  return [currentParts].concat((0,_home_user_vestapp_arnaldo_Projetos_vestapp_aplicativo_node_modules_babel_runtime_helpers_esm_toConsumableArray_js__WEBPACK_IMPORTED_MODULE_0__["default"])(getAllMonthsInRange(getNextMonth(currentParts), maxParts)));
};
/**
...
var getCombinedDateColumnData = function getCombinedDateColumnData(locale, refParts, todayParts, minParts, maxParts, dayValues, monthValues) {
  var items = [];
  var parts = [];
  /**
  ...
  months.forEach(function (monthObject) {
    ...
    monthDays.forEach(function (dayObject) {
      ...
      dateColumnItems.push({
        ...
        value: "".concat(refParts.year, "-").concat(monthObject.month, "-").concat(dayObject.value)
      });
      /**
    ...
    parts = [].concat((0,_home_user_vestapp_arnaldo_Projetos_vestapp_aplicativo_node_modules_babel_runtime_helpers_esm_toConsumableArray_js__WEBPACK_IMPORTED_MODULE_0__["default"])(parts), dateParts);
    items = [].concat((0,_home_user_vestapp_arnaldo_Projetos_vestapp_aplicativo_node_modules_babel_runtime_helpers_esm_toConsumableArray_js__WEBPACK_IMPORTED_MODULE_0__["default"])(items), dateColumnItems);
  });
  return {
    parts: parts,
    items: items
