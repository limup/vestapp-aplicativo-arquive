(function () {
  ...
  (self["webpackChunkVestApp_Marketplace"] = self["webpackChunkVestApp_Marketplace"] || []).push([["src_app_tab2_tab2_module_ts"], {
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      var _AccountService = function AccountService(httpClient) {
      ...
      _AccountService = (0, tslib__WEBPACK_IMPORTED_MODULE_2__.__decorate)([(0, _angular_core__WEBPACK_IMPORTED_MODULE_3__.Injectable)({
        providedIn: 'root'
      })], _AccountService);
      /***/
    },
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      var _Tab2Page = /*#__PURE__*/function () {
        function Tab2Page(accountService, authService, loadingController, route, router) {
        ...
        _createClass(Tab2Page, [{
          ...
          value: function login(loginForm) {
            if (loginForm.invalid) {
              ...
              var _loginForm$value = loginForm.value,
      ...
      _Tab2Page = (0, tslib__WEBPACK_IMPORTED_MODULE_6__.__decorate)([(0, _angular_core__WEBPACK_IMPORTED_MODULE_7__.Component)({
        selector: 'app-tab2',
